...
// Ver si el tamaño del heap es 1
...
// Insertar un nuevo nodo en el MinHeap
...
// Ver si el nodo es una hoja
int isLeaf(struct MinHeapNode* root) {
    return !(root->left) && !(root->right);
}

// Crear y construir el MinHeap inicial
